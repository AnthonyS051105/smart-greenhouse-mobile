 ...
 * [Routes.BUYER_MARKETPLACE], [Routes.BUYER_MAP] & [Routes.BUYER_ORDERS] sudah punya destination —
 * tab Profil tampil (sesuai desain Stitch) tapi belum menavigasi ke mana pun (lihat TODO di NavGraph.kt).
 */
